...
spark.sql('select tt.originalTitle, tt.startYear, tt.endYear, bc.averageRating, bc.numVotes \
          from ThongTin as tt, BinhChon as bc \
          where tt.titleType like "tvSeries" \
          and tt.tconst = bc.tconst \
          and bc.numVotes > 150000 \
          order by bc.averageRating desc').show(7)
